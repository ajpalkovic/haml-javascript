...
(function($) {
    var views = {
        attributes: '<div class="class"></div><div class="class"></div><div class="class"></div><div class="class"></div><div class="class" id="id"></div><div class="class" id="id"></div><div class="class" id="id" title="{class: \'class\', id: "class"", :noob => /noob/}"></div><div class="class"></div><div class="class"></div><div class="class" id="id"></div><div class="class" id="id"></div><div class="class" id="id" title="{class: \'class\', id: "class"", :noob => /noob/}"></div><div class="class" id="id" title="test12"></div><div class="class" id="id" title="test12" alt="alt"></div><div class="class" id="id" title="valuetest12" alt="alt"></div><div class="class"></div><div class="class"></div><div class="class"></div><div class="class"></div><div class="class"></div><div class="class" id="id"></div><div class="class" id="id" title="{class: \'class\', id: "class"", :noob => /noob/}"></div><div class="class" id="id" title="(class=\'class\' id="class"" noob=/noob/}"></div><div class="class" id="id" title="test12"></div><div class="class" id="id" title="test12" alt="alt"></div><div class="class" id="id" title="valuetest12" alt="alt"></div>',
        empty: '',
